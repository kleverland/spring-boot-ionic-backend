package com.kleverland.cursomc.config;
...
public class SwaggerConfig {
	...
	private final ResponseMessage m403 = simpleMessage(500, "Erro inesperado");
	private final ResponseMessage m404 = simpleMessage(404, "Não encontrado");
	private final ResponseMessage m422 = simpleMessage(422, "Erro de validação"); 
	private final ResponseMessage m500 = simpleMessage(403, "Não autorizado");
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.kleverland.cursomc.resources"))
